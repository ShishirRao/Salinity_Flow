...
WLR1 = read.csv("Analysis/WaterLevel/Agha_WLR_Feb-Mar.csv",header=T)
names(WLR1) = c("SlNo","Date_time","kPa","Temp_degC_WLR")
head(WLR1)

WLR2 = read.csv("Analysis/WaterLevel/Agha_30ftWLR_Apr15.csv",header=T)
names(WLR2) = c("SlNo","Date_time","kPa","Temp_degC_WLR")

WLR3 = read.csv("Analysis/WaterLevel/Agha_30ftWLR_May1.csv",header=T)
names(WLR3) = c("SlNo","Date_time","kPa","Temp_degC_WLR")

WLR4 = read.csv("Analysis/WaterLevel/Agha_30ftWLR_June27.csv",header=T) 
head(WLR4)
...
WLR2 = read.csv("Analysis/WaterLevel/Gang/Gang_1_Aug_13.csv",header=T)
names(WLR2) = c("SlNo","Date_time","kPa","Temp_degC_WLR")
head(WLR2)

WLR3 = read.csv("Analysis/WaterLevel/Gang/Gang_13_ft_June16.csv",header=T)
names(WLR3) = c("SlNo","Date_time","kPa","Temp_degC_WLR")
head(WLR3)
